...
class _EditProfileScreenState extends State<EditProfileScreen> with TickerProviderStateMixin {
    ...
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        if (_phoneNumberChanged) {
          ...
          if (_hasValidIndianPrefix(phone) && _isValidIndianPhoneNumber(phone)) {
            updateData['isPhoneVerified'] = true;
            print('✅ Phone number verified with proper format (+91 and 10 digits)');
          } else {
            updateData['isPhoneVerified'] = false;
            print('⚠️ Phone number not verified - must have +91 and be valid 10-digit Indian number');
          }
        }
        ...
        if (_phoneNumberChanged) {
          if (_hasValidIndianPrefix(_phoneController.text.trim()) &&
            ...
            successMessage = 'Profile updated and phone number verified! (+91 ${_phoneController.text.trim()})';
          } else {
            successMessage = 'Profile updated. Please use format +91XXXXXXXXXX for verification.';
          }
        }

        _showSnackbar(successMessage,
            isSuccess: _phoneNumberChanged &&
            ...
            Container(
              ...
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  colors: [EditProfileColors.primary.withOpacity(0.1), EditProfileColors.secondary.withOpacity(0.1)],
                  begin: Alignment.topLeft,
                  end: Alignment.bottomRight,
                ),
                shape: BoxShape.circle,
              ...
              child: const CircularProgressIndicator(
                valueColor: AlwaysStoppedAnimation<Color>(EditProfileColors.primary),
                strokeWidth: 3,
              ),
            ),
        ...
        child: Form(
          ...
          child: Column(
            children: [
                      ...
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            boxShadow: [
                              BoxShadow(
                                color: EditProfileColors.primary.withOpacity(0.3 * _pulseAnimationController.value),
                                blurRadius: 20,
                              ...
                              child: ClipOval(
                                child: _selectedImage != null
                                  ...
                                  errorWidget: (context, url, error) => Container(
                                    ...
                                    : Container(
                                  color: Colors.grey[100],
                                  child: Icon(Icons.person, size: 40, color: EditProfileColors.primary),
                                )),
                              ),
                            ),
                          ),
              ...
              _buildSectionTitle('Personal Information', EditProfileColors.primary),
              const SizedBox(height: 16),
              ...
              Container(
                ...
                child: CustomTextField(
                  ...
                  prefixIcon: Icon(Icons.person_outline, color: EditProfileColors.primary),
                  validator: (value) {
                ...
                children: [
                  Container(
                    ...
                    child: CustomTextField(
                      ...
                      prefixIcon: Icon(Icons.phone_outlined, color: EditProfileColors.secondary),
                  ...
                  if (user?.isPhoneVerified == true && !_phoneNumberChanged)
                    Container(
                      padding: const EdgeInsets.all(12),
                      decoration: BoxDecoration(
                        gradient: const LinearGradient(
                          colors: [EditProfileColors.success, EditProfileColors.tertiary],
                          begin: Alignment.topLeft,
                          end: Alignment.bottomRight,
                        ),
                        borderRadius: BorderRadius.circular(16),
                ...
                child: Row(
                  children: [
                    Container(
                      ...
                      child: const Icon(Icons.email_outlined, color: EditProfileColors.primary),
                    ),
                    const SizedBox(width: 12),
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          if (user?.isEmailVerified == true)
                            Row(
                              children: [
                                const Icon(Icons.verified, size: 12, color: EditProfileColors.success),
              ...
              // About Section
              _buildSectionTitle('About You', EditProfileColors.secondary),
              const SizedBox(height: 16),
              ...
              Container(
                ...
                child: CustomTextField(
                  ...
                  prefixIcon: Icon(Icons.location_on_outlined, color: EditProfileColors.tertiary),
                ),
              ),
              const SizedBox(height: 24),

              // Interests Section
              _buildSectionTitle('Travel Interests', EditProfileColors.tertiary),
              const SizedBox(height: 8),
              Text(
              ...
              if (!(user?.isEmailVerified ?? false)) ...[
                _buildSectionTitle('Verification', EditProfileColors.warning),
                const SizedBox(height: 16),
                Container(
                  padding: const EdgeInsets.all(16),
                  decoration: BoxDecoration(
                    gradient: LinearGradient(
                      colors: [EditProfileColors.warning.withOpacity(0.1), EditProfileColors.secondary.withOpacity(0.05)],
                      begin: Alignment.topLeft,
                      end: Alignment.bottomRight,
                    ),
                    borderRadius: BorderRadius.circular(20),
                  ...
                  child: Row(
                    children: [
                      Container(
                        padding: const EdgeInsets.all(8),
                        decoration: BoxDecoration(
                          color: EditProfileColors.warning.withOpacity(0.1),
                          borderRadius: BorderRadius.circular(12),
                        ),
                        child: const Icon(Icons.warning, color: EditProfileColors.warning),
                      ),
                      const SizedBox(width: 12),
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              ...
                              style: GoogleFonts.poppins(
                                fontSize: 12,
                                color: EditProfileColors.warning.withOpacity(0.8),
                              ),
                            ),
                          ],
                        ),
                      ...
                      Container(
                        decoration: BoxDecoration(
                          gradient: const LinearGradient(
                            colors: [EditProfileColors.warning, EditProfileColors.secondary],
                            begin: Alignment.topLeft,
                            end: Alignment.bottomRight,
                          ),
                          borderRadius: BorderRadius.circular(16),
              ...
              _buildSectionTitle('Student Verification', EditProfileColors.lavender),
              const SizedBox(height: 16),
              Container(
                padding: const EdgeInsets.all(16),
                decoration: BoxDecoration(
                  gradient: LinearGradient(
                    colors: [EditProfileColors.lavender.withOpacity(0.1), EditProfileColors.primary.withOpacity(0.05)],
                    begin: Alignment.topLeft,
                    end: Alignment.bottomRight,
                  ),
                  borderRadius: BorderRadius.circular(20),
                ...
                child: Row(
                  children: [
                    Container(
                      ...
                      child: const Icon(Icons.school, color: EditProfileColors.lavender),
                    ),
                    const SizedBox(width: 12),
                    Expanded(
                      child: Column(
                    ...
                    if (user?.isStudentVerified ?? false)
                      ...
                      Container(
                        decoration: BoxDecoration(
                          gradient: const LinearGradient(
                            colors: [EditProfileColors.lavender, EditProfileColors.primary],
                            begin: Alignment.topLeft,
                            end: Alignment.bottomRight,
                          ),
                          borderRadius: BorderRadius.circular(16),
                        ...
                        child: TextButton(
                          onPressed: () {
                            _showSnackbar('Student ID upload coming soon');
                          },
                          style: TextButton.styleFrom(
                            foregroundColor: Colors.white,
                            padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 8),
  ...
  List<Color> _getValidationColors() {
    if (_hasValidIndianPrefix(_phoneController.text) && _isValidIndianPhoneNumber(_phoneController.text)) {
